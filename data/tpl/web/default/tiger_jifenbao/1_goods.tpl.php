...
<ul class="nav nav-tabs">
	...
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('goods', array('op' => 'display'));?>">管理</a></li>
</ul>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <select class="form-control" name="type">
                    ...
                    <option <?php  if(!empty($item) && $item['type'] == 5) { ?>selected<?php  } ?> value="5">兑换红包(自动兑换)</option>
